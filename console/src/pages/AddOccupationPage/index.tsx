...
const AddOccupationPage = memo(() => {
  const { t } = useTranslation("AddOccupationPage");
  const navigate = useNavigate();
  const form = useInitOccupationForm();
  const { onSubmit, onSubmitError, isPending } = useSubmitOccupation();
...
AddOccupationPage.displayName = "AddOccupationPage";
