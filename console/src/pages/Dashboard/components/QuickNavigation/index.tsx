import { CameraIcon, GearIcon, StackIcon, UserIcon, UserPlusIcon, XIcon, type AnimatedIconComponent } from "nfx-ui/icons";
import { memo, useState } from "react";
import { useNavigate } from "react-router";

import { showConfirm, showInfo } from "@/stores/modal";
import QuickStore, { ALL_AVAILABLE_ITEMS, useQuickStore } from "@/stores/quickStore";

import styles from "./s.module.css";

const ICON_BY_NAME: Record<string, AnimatedIconComponent> = {
  User: UserIcon,
  Image: CameraIcon,
  Settings: GearIcon,
};
