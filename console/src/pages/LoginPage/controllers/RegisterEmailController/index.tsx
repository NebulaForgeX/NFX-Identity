    ...
    <Controller
      ...
      render={({ field, fieldState }) => (
        <Flex direction="column" gap="1" flexGrow="1">
          <Text as="label" size="2" weight="medium" htmlFor="register-email">
            {t("email")}
          </Text>
          <TextField.Root id="register-email" size="3" type="email" autoComplete="email" placeholder={t("email")} color={fieldState.error ? "red" : undefined} {...field} />
          {errors.email ? (
