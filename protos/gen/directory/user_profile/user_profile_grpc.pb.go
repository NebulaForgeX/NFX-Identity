...
func (c *userProfileServiceClient) GetUserProfileByUserID(ctx context.Context, in *GetUserProfileByUserIDRequest, opts ...grpc.CallOption) (*GetUserProfileByUserIDResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetUserProfileByUserIDResponse)
	err := c.cc.Invoke(ctx, UserProfileService_GetUserProfileByUserID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserProfileServiceServer) GetUserProfileByUserID(context.Context, *GetUserProfileByUserIDRequest) (*GetUserProfileByUserIDResponse, error) {
...
func _UserProfileService_GetUserProfileByUserID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetUserProfileByUserIDRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserProfileServiceServer).GetUserProfileByUserID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserProfileService_GetUserProfileByUserID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserProfileServiceServer).GetUserProfileByUserID(ctx, req.(*GetUserProfileByUserIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserProfileService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserProfileService_GetUserProfileByUserID_Handler,
		},
		{
	...
	Metadata: "directory/user_profile.proto",
}
