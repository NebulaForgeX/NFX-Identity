...
func (g *Generator) GenerateAccessToken(userID, username, email, phone, roleID string) (string, error) {
	claims := NewAccessTokenClaims(userID, username, email, phone, roleID, g.cfg.Issuer, g.cfg.AccessTokenTTL)
	return g.signToken(claims)
}

// GenerateRefreshToken 生成 Refresh Token
func (g *Generator) GenerateRefreshToken(userID, username, email, phone, roleID string) (string, error) {
	claims := NewRefreshTokenClaims(userID, username, email, phone, roleID, g.cfg.Issuer, g.cfg.RefreshTokenTTL)
	return g.signToken(claims)
}
