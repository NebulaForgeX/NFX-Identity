...
// ByTenantIDAndMemberID 根据 TenantID 和 MemberID 获取 MemberRole 列表，实现 member_roles.Get 接口
func (h *Handler) ByTenantIDAndMemberID(ctx context.Context, tenantID, memberID uuid.UUID) ([]*member_roles.MemberRole, error) {
