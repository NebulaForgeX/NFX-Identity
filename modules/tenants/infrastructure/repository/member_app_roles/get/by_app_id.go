...
// ByAppID 根据 AppID 获取 MemberAppRole 列表，实现 member_app_roles.Get 接口
func (h *Handler) ByAppID(ctx context.Context, appID uuid.UUID) ([]*member_app_roles.MemberAppRole, error) {
