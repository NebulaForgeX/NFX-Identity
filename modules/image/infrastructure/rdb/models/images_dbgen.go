...
type Image struct {
	...
	UserID           *uuid.UUID      `gorm:"type:uuid;index:idx_images_user_id;index:idx_images_user_public,priority:1"`
...
var ImageCols = struct {
	ID, TypeID, UserID, SourceDomain, Filename, OriginalFilename, MimeType,
	Size, Width, Height, StoragePath, URL, IsPublic, Metadata,
