...
type IpAllowlist struct {
	...
	AppID        uuid.UUID                    `gorm:"type:uuid;index:idx_ip_allowlist_app_id;index:idx_ip_allowlist_app_status,priority:1"`
...
var IpAllowlistCols = struct {
	ID, RuleID, AppID, Cidr, Description, Status, CreatedAt,
...
const (
	...
	IpAllowlistFkAppIdFkey = "ip_allowlist_app_id_fkey"
)
