...
// ByUserID 根据 UserID 获取 UserOccupation 列表，实现 user_occupations.Get 接口
func (h *Handler) ByUserID(ctx context.Context, userID uuid.UUID) ([]*user_occupations.UserOccupation, error) {
