...
// ByUserID 根据 UserID 获取 PasswordHistory 列表，实现 password_history.Get 接口
func (h *Handler) ByUserID(ctx context.Context, userID uuid.UUID) ([]*password_history.PasswordHistory, error) {
