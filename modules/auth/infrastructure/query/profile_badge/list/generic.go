...
// Generic 获取 ProfileBadge 列表，实现 profileBadgeDomain.List 接口
func (h *Handler) Generic(ctx context.Context, listQuery profileBadgeDomain.ListQuery) ([]*profileBadgeDomainViews.ProfileBadgeView, int64, error) {
