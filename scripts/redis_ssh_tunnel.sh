#!/usr/bin/env bash
# Interactive SSH local-forward to ElastiCache via a VPC jump EC2 (NFX-Identity-owned).
# Used by `task run` before docker compose up. PulsoNear has its own copy/script
# (default local port 16380; this repo uses 16379).
#
