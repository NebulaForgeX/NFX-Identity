...
var (
	...
	ErrDynamoDBRemoteCredentialsMissing = errx.InvalidArg("DYNAMODB_REMOTE_CREDENTIALS_MISSING", "DYNAMODB_IF_REMOTE=true requires AWS_ACCESS_KEY_ID and AWS_SECRET_ACCESS_KEY")
	...
	// AWS Location
	ErrLocationRegionEmpty = errx.InvalidArg("LOCATION_REGION_EMPTY", "Location service region is empty")
	ErrLocationAPIKeyEmpty = errx.InvalidArg("LOCATION_API_KEY_EMPTY", "Location service API key is empty")
	ErrLocationInputNil    = errx.InvalidArg("LOCATION_INPUT_NIL", "Location service input is nil")
	ErrLocationInternal    = errx.Internal("LOCATION_INTERNAL", "Location service operation failed")
	...
	ErrNotFound         = errx.NotFound("NOT_FOUND", "not found")
	ErrBadRequest       = errx.InvalidArg("BAD_REQUEST", "bad request")
	ErrMethodNotAllowed = errx.InvalidArg("METHOD_NOT_ALLOWED", "method not allowed")
	ErrInvalidParams    = errx.InvalidArg("INVALID_PARAMS", "invalid request parameters")
	ErrInvalidBody      = errx.InvalidArg("INVALID_BODY", "invalid request body")
	ErrInvalidQuery     = errx.InvalidArg("INVALID_QUERY", "invalid request query")
	ErrUnimplemented    = errx.FailedPrecond("UNIMPLEMENTED", "not implemented")
)
...
!DYNAMODB_REMOTE_CREDENTIALS_MISSING
*en<DYNAMODB_IF_REMOTE=true requires AWS_ACCESS_KEY_ID and AWS_SECRET_ACCESS_KEY>
*zh<DYNAMODB_IF_REMOTE=true 时必须配置 AWS_ACCESS_KEY_ID 与 AWS_SECRET_ACCESS_KEY>
*fr<DYNAMODB_IF_REMOTE=true nécessite AWS_ACCESS_KEY_ID et AWS_SECRET_ACCESS_KEY>
...
!LOCATION_REGION_EMPTY
*en<Location service region is empty>
*zh<Location 服务 region 未配置>
*fr<La région du service Location est vide>

!LOCATION_API_KEY_EMPTY
*en<Location service API key is empty>
*zh<Location 服务 API key 未配置>
*fr<La clé API du service Location est vide>

!LOCATION_INPUT_NIL
*en<Location service input is nil>
*zh<Location 服务输入为空>
*fr<L'entrée du service Location est nulle>

!LOCATION_INTERNAL
*en<Location service operation failed>
*zh<Location 服务操作失败>
*fr<Échec de l'opération du service Location>
