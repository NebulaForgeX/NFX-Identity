...
CREATE TABLE "access"."tenant_roles" (
  ...
  PRIMARY KEY ("id"),
  CONSTRAINT "tenant_roles_tenant_id_role_key_key" UNIQUE ("tenant_id", "role_key")
);
-- Create index "idx_tenant_roles_role_key" to table: "tenant_roles"
CREATE INDEX "idx_tenant_roles_role_key" ON "access"."tenant_roles" ("role_key");
-- Create index "idx_tenant_roles_tenant_id" to table: "tenant_roles"
CREATE INDEX "idx_tenant_roles_tenant_id" ON "access"."tenant_roles" ("tenant_id");
-- Create "application_role_assignments" table
CREATE TABLE "access"."application_role_assignments" (
  "id" uuid NOT NULL DEFAULT gen_random_uuid(),
  ...
  PRIMARY KEY ("id"),
  CONSTRAINT "application_role_assignments_user_id_application_id_key" UNIQUE ("user_id", "application_id")
);
-- Create index "idx_application_role_assignments_application_id" to table: "application_role_assignments"
CREATE INDEX "idx_application_role_assignments_application_id" ON "access"."application_role_assignments" ("application_id");
-- Create index "idx_application_role_assignments_application_role_id" to table: "application_role_assignments"
CREATE INDEX "idx_application_role_assignments_application_role_id" ON "access"."application_role_assignments" ("application_role_id");
-- Create index "idx_application_role_assignments_user_id" to table: "application_role_assignments"
CREATE INDEX "idx_application_role_assignments_user_id" ON "access"."application_role_assignments" ("user_id");
-- Create "application_roles" table
CREATE TABLE "access"."application_roles" (
  "id" uuid NOT NULL DEFAULT gen_random_uuid(),
  "application_id" uuid NOT NULL,
  "role_key" character varying(32) NOT NULL,
  "name" character varying(255) NULL,
  "created_at" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY ("id"),
  CONSTRAINT "application_roles_application_id_role_key_key" UNIQUE ("application_id", "role_key")
);
-- Create index "idx_application_roles_application_id" to table: "application_roles"
CREATE INDEX "idx_application_roles_application_id" ON "access"."application_roles" ("application_id");
-- Create index "idx_application_roles_role_key" to table: "application_roles"
CREATE INDEX "idx_application_roles_role_key" ON "access"."application_roles" ("role_key");
-- Create "super_admins" table
CREATE TABLE "access"."super_admins" (
  "user_id" uuid NOT NULL,
  "created_at" timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY ("user_id")
);
-- Create index "idx_super_admins_user_id" to table: "super_admins"
CREATE INDEX "idx_super_admins_user_id" ON "access"."super_admins" ("user_id");
-- Create "tenant_role_assignments" table
CREATE TABLE "access"."tenant_role_assignments" (
  "id" uuid NOT NULL DEFAULT gen_random_uuid(),
  "user_id" uuid NOT NULL,
  "tenant_id" uuid NOT NULL,
  ...
  "assigned_by" uuid NULL,
  PRIMARY KEY ("id"),
  CONSTRAINT "tenant_role_assignments_user_id_tenant_id_key" UNIQUE ("user_id", "tenant_id")
);
-- Create index "idx_tenant_role_assignments_tenant_id" to table: "tenant_role_assignments"
CREATE INDEX "idx_tenant_role_assignments_tenant_id" ON "access"."tenant_role_assignments" ("tenant_id");
-- Create index "idx_tenant_role_assignments_tenant_role_id" to table: "tenant_role_assignments"
CREATE INDEX "idx_tenant_role_assignments_tenant_role_id" ON "access"."tenant_role_assignments" ("tenant_role_id");
-- Create index "idx_tenant_role_assignments_user_id" to table: "tenant_role_assignments"
CREATE INDEX "idx_tenant_role_assignments_user_id" ON "access"."tenant_role_assignments" ("user_id");
...
-- Create index "idx_events_application_id" to table: "events"
CREATE INDEX "idx_events_application_id" ON "audit"."events" ("application_id");
...
-- Create index "idx_refresh_tokens_application_id" to table: "refresh_tokens"
CREATE INDEX "idx_refresh_tokens_application_id" ON "auth"."refresh_tokens" ("application_id");
...
-- Create index "idx_sessions_application_id" to table: "sessions"
CREATE INDEX "idx_sessions_application_id" ON "auth"."sessions" ("application_id");
...
CREATE TABLE "clients"."applications" (
  "id" uuid NOT NULL DEFAULT gen_random_uuid(),
...
-- Create index "idx_applications_application_id" to table: "applications"
CREATE INDEX "idx_applications_application_id" ON "clients"."applications" ("application_id");
-- Create index "idx_applications_deleted_at" to table: "applications"
CREATE INDEX "idx_applications_deleted_at" ON "clients"."applications" ("deleted_at");
-- Create index "idx_applications_environment" to table: "applications"
CREATE INDEX "idx_applications_environment" ON "clients"."applications" ("environment");
-- Create index "idx_applications_status" to table: "applications"
CREATE INDEX "idx_applications_status" ON "clients"."applications" ("status");
-- Create index "idx_applications_tenant_environment" to table: "applications"
CREATE INDEX "idx_applications_tenant_environment" ON "clients"."applications" ("tenant_id", "environment");
-- Create index "idx_applications_tenant_id" to table: "applications"
CREATE INDEX "idx_applications_tenant_id" ON "clients"."applications" ("tenant_id");
...
-- Create enum type "tenant_application_status"
...
CREATE TABLE "clients"."client_credentials" (
  ...
  CONSTRAINT "client_credentials_application_id_fkey" FOREIGN KEY ("application_id") REFERENCES "clients"."applications" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
-- Create index "idx_client_credentials_app_status" to table: "client_credentials"
CREATE INDEX "idx_client_credentials_app_status" ON "clients"."client_credentials" ("application_id", "status") WHERE (status = 'active'::clients.credential_status);
-- Create index "idx_client_credentials_application_id" to table: "client_credentials"
CREATE INDEX "idx_client_credentials_application_id" ON "clients"."client_credentials" ("application_id");
...
-- Create index "idx_images_application_id" to table: "images"
...
-- Create index "idx_images_tenant_application" to table: "images"
...
-- Set comment to column: "application_id" on table: "images"
...
-- Create index "idx_invitations_tenant_role_id" to table: "invitations"
CREATE INDEX "idx_invitations_tenant_role_id" ON "tenants"."invitations" ("tenant_role_id");
...
CREATE TABLE "clients"."ip_allowlist" (
  ...
  CONSTRAINT "ip_allowlist_application_id_fkey" FOREIGN KEY ("application_id") REFERENCES "clients"."applications" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
-- Create index "idx_ip_allowlist_app_status" to table: "ip_allowlist"
CREATE INDEX "idx_ip_allowlist_app_status" ON "clients"."ip_allowlist" ("application_id", "status") WHERE (status = 'active'::clients.allowlist_status);
-- Create index "idx_ip_allowlist_application_id" to table: "ip_allowlist"
CREATE INDEX "idx_ip_allowlist_application_id" ON "clients"."ip_allowlist" ("application_id");
...
CREATE TABLE "clients"."rate_limits" (
  ...
  "updated_by" uuid NULL,
  PRIMARY KEY ("id"),
  CONSTRAINT "rate_limits_application_id_limit_type_key" UNIQUE ("application_id", "limit_type"),
  CONSTRAINT "rate_limits_application_id_fkey" FOREIGN KEY ("application_id") REFERENCES "clients"."applications" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
-- Create index "idx_rate_limits_application_id" to table: "rate_limits"
CREATE INDEX "idx_rate_limits_application_id" ON "clients"."rate_limits" ("application_id");
...
CREATE TABLE "tenants"."tenant_applications" (
  ...
  PRIMARY KEY ("id"),
  CONSTRAINT "tenant_applications_tenant_id_application_id_key" UNIQUE ("tenant_id", "application_id"),
  CONSTRAINT "tenant_applications_tenant_id_fkey" FOREIGN KEY ("tenant_id") REFERENCES "tenants"."tenants" ("id") ON UPDATE NO ACTION ON DELETE CASCADE
);
-- Create index "idx_tenant_applications_application_id" to table: "tenant_applications"
CREATE INDEX "idx_tenant_applications_application_id" ON "tenants"."tenant_applications" ("application_id");
-- Create index "idx_tenant_applications_status" to table: "tenant_applications"
CREATE INDEX "idx_tenant_applications_status" ON "tenants"."tenant_applications" ("status");
-- Create index "idx_tenant_applications_tenant_id" to table: "tenant_applications"
CREATE INDEX "idx_tenant_applications_tenant_id" ON "tenants"."tenant_applications" ("tenant_id");
